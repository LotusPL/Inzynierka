...
public class MainActivity extends AppCompatActivity implements OnConnectionFailedListener, GoogleApiClient.ConnectionCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Switch bluetoothSwitch = (Switch) findViewById(R.id.switch1);
        ...
        */
        ...
        mapsButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String uri = String.format(Locale.ENGLISH, "geo:%f,%f?q="+mLastLocation.getLatitude()+","+ mLastLocation.getLongitude(), mLastLocation.getLatitude(),mLastLocation.getLongitude());
...
/*    private IBeaconListener createIBeaconListener() {
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        mLastLocation = LocationServices.FusedLocationApi.getLastLocation(
                mGoogleApiClient);
        //loc.add(mLastLocation.getLatitude());
        //loc.add(mLastLocation.getLongitude());
